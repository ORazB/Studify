...
<body>
    ...
    <section class="register min-h-screen flex items-center justify-center">
        <div class="container mx-auto bg-white rounded-xl grid grid-cols-2 overflow-hidden max-w-5xl">
          ...
          <div class="forms flex flex-col justify-center px-11 py-10">
            ...
            <div class="button_cta flex gap-3">
                ...
                <i class='bxl bx-google'></i> Sign up with Google
                </button>
                <button class="w-full mb-3 bg-[#ccece6] rounded-full py-2 shadow">
                <i class='bxl  bx-github'  style='color:#000000'></i> Sign up with Github
                </button>
            </div>
            
            <div class="forms_input my-4">
              <input type="text" placeholder="Username" class="w-full rounded-full px-4 py-3 bg-[#ccece6]"/>
            </div>
            <div class="forms_input mb-4">
              <input type="text" placeholder="Password" class="w-full rounded-full px-4 py-3 bg-[#ccece6]"/>
            </div>
            ...
            <button class="w-full bg-black text-white rounded-full py-2 shadow">Register</button>
