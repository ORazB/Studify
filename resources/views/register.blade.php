    ...
    <div class="container mx-auto bg-white rounded-xl grid grid-cols-2 overflow-hidden max-w-5xl">
      ...
      <div class="forms flex flex-col justify-center px-11 py-10">
        ...
        <form action="{{ route('users.store') }}" method="POST">
          ...
          <div class="forms_input mb-4">
            <select name="role" class="w-full rounded-full px-4 py-3 bg-[#ccece6] focus:outline-none focus:ring-2 focus:ring-[#ccece6]">
          ...
          <button type="submit" class="w-full bg-black text-white rounded-full py-2 shadow">Register</button>
        </form>
